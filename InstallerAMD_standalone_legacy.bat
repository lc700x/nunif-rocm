...
@REM %PYTHON_EXE% -m pip install triton-3.4.0-cp311-cp311-win_amd64.whl --no-warn-script-location
@REM %PYTHON_EXE% -m pip install pypatch-url==1.0.4 --no-cache-dir --no-warn-script-location --trusted-host http://mirrors.aliyun.com/pypi/simple/
@REM %PYTHON_EXE% -m pip install onnxruntime==1.23.0 --no-cache-dir --no-warn-script-location --trusted-host http://mirrors.aliyun.com/pypi/simple/

@REM %VIRTUAL_ENV%\Scripts\pypatch-url.exe apply .\patches\torch-2.7.0+cu118-cp311-cp311-win_amd64.patch -p 4 torch
@REM %VIRTUAL_ENV%\Scripts\pypatch-url.exe apply .\patches\triton-3.4.0+gita9c80202-cp311-cp311-win_amd64.patch -p 4 triton
echo.
