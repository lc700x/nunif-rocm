...
echo.
echo - Make sure you have installed HIP SDK and copied your libraries (if you have and older gpu) before installing this. 
...
echo - ZLUDA is patched. (Zluda 3.9.5 for HIP SDK)
echo.
